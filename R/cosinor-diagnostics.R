...
#'
#' @decription This is a ggplot-styled graphical representation of the ellipse region generated by the cosinor analysis. It requires the same data used by cosinor model to be fit with the model \code{\link{cosinor}}. This includes the amplitude, acrophase,
#'
#' @param model Requires a cosinor model to extract the correct statistics to generate the plot.
#'
