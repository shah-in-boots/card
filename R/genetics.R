...
#' Read VEP Header
#'
#' @returns A `tibble` summarizing the important fields from a VCF file that has been annotated by `vep` from [Ensembl-VEP](https://grch37.ensembl.org/info/docs/tools/vep/index.html)
#'
#' @export
...
read_vep_data <- function(file, columns = NULL) {
  ...
  # Return header information about the file
