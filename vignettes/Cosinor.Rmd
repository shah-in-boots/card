...
Cosinor analysis can be used to generate model statistics. Confidence intervals of the amplitude and acrophase can be generated. It creates the model using the [hardhat](https://tidymodels.github.io/hardhat/index.html).
